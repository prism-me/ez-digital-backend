<table style="width:700px; background-color: #f7f7f7; margin: 0 auto; font-family: sans-serif;">
  ...
  <tr>
    <td colspan="3" style="paddigng: 20px;"><p>Hi {{ $user['name']}}, </p> <p>Your order has been successfully placed.</br>Your order has been successfully placed.<br />For your reference, your dummy password is
    {{ $user['password']}}</p></td>
  </tr>
  ...
  <tr>
	<td colspan="3" style="padding:0px 20px;">
		...
		<table style="width:100%; background-color: #ffffff;  padding:20px; border-radius: 5px;">
			...
			<td style="padding:15px; border-bottom: 1px solid #e6e6e6;"><strong>Service Name</strong></br> Quantity: 1</td>
			<td style="padding:15px; border-bottom: 1px solid #e6e6e6;">{{@$user['name']}}</td>
			</tr>
